...
class BannerVenda(GridLayout):
    def __init__(self, **kwargs):
        ...
        direita = FloatLayout()
        direita_label_data = Label(text=f"Data: {data_venda}", size_hint=(1, 0.33), pos_hint={"right": 1, "top": 0.9})
        direita_label_preco = Label(text=f"Preço: {preco}", size_hint=(1, 0.33), pos_hint={"right": 1, "top": 0.65})
